...
proc create_root_design { parentCell } {
  ...
  # Create instance: nn_mem_controller_0, and set properties
  set nn_mem_controller_0 [ create_bd_cell -type ip -vlnv tuwien.at:user:nn_mem_controller:1.0 nn_mem_controller_0 ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins nn_mem_controller_0/S00_AXIS_DMA]
  ...
  connect_bd_intf_net -intf_net nn_mem_controller_0_BRAM_PORTA [get_bd_intf_pins blk_mem_gen_0/BRAM_PORTA] [get_bd_intf_pins nn_mem_controller_0/BRAM_PORTA]
  connect_bd_intf_net -intf_net nn_mem_controller_0_BRAM_PORTB [get_bd_intf_pins blk_mem_gen_0/BRAM_PORTB] [get_bd_intf_pins nn_mem_controller_0/BRAM_PORTB]
  connect_bd_intf_net -intf_net nn_mem_controller_0_M00_AXIS_DMA [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins nn_mem_controller_0/M00_AXIS_DMA]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins nn_mem_controller_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins axi_dma_0/mm2s_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins nn_mem_controller_0/m00_axis_dma_aclk] [get_bd_pins nn_mem_controller_0/m_layer_clk_i] [get_bd_pins nn_mem_controller_0/s00_axi_aclk] [get_bd_pins nn_mem_controller_0/s00_axis_dma_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins nn_mem_controller_0/m00_axis_dma_aresetn] [get_bd_pins nn_mem_controller_0/m_layer_aresetn_i] [get_bd_pins nn_mem_controller_0/s00_axi_aresetn] [get_bd_pins nn_mem_controller_0/s00_axis_dma_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs nn_mem_controller_0/S00_AXI/S00_AXI_reg] SEG_nn_mem_controller_0_S00_AXI_reg
