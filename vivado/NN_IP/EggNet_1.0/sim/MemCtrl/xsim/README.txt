...
#
# Generated by export_simulation on Mon Jan 06 19:38:56 +0100 2020
#
################################################################################
...
'-reset_run' switch to the './tb_memctrl.sh' script.

./tb_memctrl.sh -reset_run
...
./tb_memctrl.sh -noclean_files

For more information on the script, please type './tb_memctrl.sh -help'.
