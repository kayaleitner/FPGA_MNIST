...
#
# create_project.tcl: Tcl script for re-creating project 'FPGA-MNIST'
#
# Generated by Vivado on Wed Dec 18 09:07:23 +0100 2019
...
#
#    "../bd/zedboard/hdl/zedboard_wrapper.vhd"
#
...
set orig_proj_dir "[file normalize "$origin_dir/../FPGA-MNIST"]"
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../NN_IP/EggNet_1.0"] [file normalize "$origin_dir/../NN_IP"]" $obj
...
set files [list \
 "[file normalize "$origin_dir/../bd/zedboard/hdl/zedboard_wrapper.vhd"]"\
]
...
set file "hdl/zedboard_wrapper.vhd"
...
# Proc to create BD zedboard
proc cr_bd_zedboard { parentCell } {
  ...
  # Create instance: NeuralNetwork, and set properties
  set NeuralNetwork [ create_bd_cell -type ip -vlnv xilinx.com:user:EggNet:1.0 NeuralNetwork ]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs NeuralNetwork/S00_AXI/S00_AXI_reg] SEG_EggNet_0_S00_AXI_reg
...
# End of cr_bd_zedboard()
cr_bd_zedboard ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files zedboard.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files zedboard.bd ] 
set_property IS_ENABLED "1" [get_files zedboard.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files zedboard.bd ] 
set_property IS_LOCKED "0" [get_files zedboard.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files zedboard.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files zedboard.bd ] 
set_property PFM_NAME "" [get_files zedboard.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files zedboard.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files zedboard.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files zedboard.bd ] 
set_property USED_IN_SIMULATION "1" [get_files zedboard.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files zedboard.bd ] 
