...
struct network_t network ={	.layer_number=0, .layers = NULL, .debug_active=0,
							.selected_layer=0};
 ...
 * @return Error code
 */
egg_error_t get_type_string(layer_type_t type);
 ...
 * @return Error code
 */
egg_error_t egg_free_network(struct network_t *net);
